...
//    String fldr = argv[4];
    ...
    while( draw.input() )
    {
        ...
        if( change )
        {
            ...
            Matd srf = marching3D( tst , occ > 0 , occ , 0.5 );
...
//                        if( dsph(j,i) == 0 )
//                        {
//                            tmp_uv.eig() << j * 85.0 , i * 85.0 , 85.0 , 1.0 ;
//                            xyzfar = poses[t].o2w( ( tmp_uv * iPRT ).cl(3) );
//                            Eig13f diff = xyzfar.eig() - ctr.eig();
...
//                            {   if( occ(u) > 0.5 )
//                                {
//                                    int dst = int( diff.norm() * ( 0.05 + u * 0.05 ) * 3 );
//                                    if( dst > 255 ) dst = 0;
//                                    dsph(j,i) = dst;
//                                    break;
//                                }
...
//            forLOOPij( dsph.r() , dsph.c() )
//                if( dsph(i,j) == -1 ) dsph(i,j) = 0;
