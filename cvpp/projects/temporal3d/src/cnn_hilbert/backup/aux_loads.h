...
void prep_dirs( const String& dir )
{
    ...
    path = dir + "/proc2";       if( stat( path.c_str() , &st ) == -1 ) mkdir( path.c_str() , 0700 );
    path = dir + "/proc2/imgs";  if( stat( path.c_str() , &st ) == -1 ) mkdir( path.c_str() , 0700 );
    path = dir + "/proc2/disp1"; if( stat( path.c_str() , &st ) == -1 ) mkdir( path.c_str() , 0700 );
    path = dir + "/proc2/disp2"; if( stat( path.c_str() , &st ) == -1 ) mkdir( path.c_str() , 0700 );
    path = dir + "/proc2/xyz";   if( stat( path.c_str() , &st ) == -1 ) mkdir( path.c_str() , 0700 );
    path = dir + "/proc2/all";   if( stat( path.c_str() , &st ) == -1 ) mkdir( path.c_str() , 0700 );
    path = dir + "/proc2/uvxyz"; if( stat( path.c_str() , &st ) == -1 ) mkdir( path.c_str() , 0700 );
}
                ...
                const Matf& xyz , const Matf& uvxyz , const Matf& all )
{
    ...
    img.saveIMG(   dir + "/proc2/imgs/"  + sufname + ".png" );
    dsp1.saveIMG(  dir + "/proc2/disp1/" + sufname + ".png" );
    dsp2.saveIMG(  dir + "/proc2/disp2/" + sufname + ".png" );
    xyz.saveBIN(   dir + "/proc2/xyz/"   + sufname + ".bin" );
    all.saveBIN(   dir + "/proc2/all/"   + sufname + ".bin" );
    uvxyz.saveBIN( dir + "/proc2/uvxyz/" + sufname + ".bin" );
}
