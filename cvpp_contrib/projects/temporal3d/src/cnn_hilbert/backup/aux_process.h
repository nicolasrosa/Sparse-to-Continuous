                    ...
                    Matf& vel , Matf& xyz , Matf& all , Matf& proj , Matf& uv , Matf& dep )
{
    ...
    Matf xyz2 = poses[t].o2w( ( ( uv.appR1() % ( dep + 0.33 ) ).appR1() * iPRT ).cl(3) );
    Matf xyz3 = poses[t].o2w( ( ( uv.appR1() % ( dep + 0.66 ) ).appR1() * iPRT ).cl(3) );
    Matf xyz4 = poses[t].o2w( ( ( uv.appR1() % ( dep + 1.00 ) ).appR1() * iPRT ).cl(3) );
    Matf xyz5 = poses[t].o2w( ( ( uv.appR1() % ( dep + 1.33 ) ).appR1() * iPRT ).cl(3) );
    Matf xyz6 = poses[t].o2w( ( ( uv.appR1() % ( dep + 1.66 ) ).appR1() * iPRT ).cl(3) );
    Matf xyz7 = poses[t].o2w( ( ( uv.appR1() % ( dep + 2.00 ) ).appR1() * iPRT ).cl(3) );
