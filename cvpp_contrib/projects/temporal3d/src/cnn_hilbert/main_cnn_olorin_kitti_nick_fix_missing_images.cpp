...
int main( int argc , char* argv[] )
{
    ...
    String path = "/media/olorin/Documentos/datasets/kitti/raw_data";
    ...
    String suf = date + "_" + fldr + "_";
    String dir_data = path + "/" + date + "/" + date + "_" + fldr + "/";
    String dir_calib = path + "/" + date + "/";

    std::cout << "suf: " << suf << endl;
    std::cout << "dir_data: " << dir_data << endl;
    std::cout << "dir_calib: " << dir_calib << endl;
    ...
    std::cout << "TRP: " << TRP << endl;
    std::cout << "iPRT: " << iPRT << endl;
