...
def argumentHandler():
    ...
    parser.add_argument('-r', '--model_path', help='Converted parameters for the model',
                        default='/home/nicolas/MEGA/workspace/FCRN-DepthPrediction/tensorflow/output/models/kitti_continuous/all_px/berhu/2019-03-18_10-02-45/restore/model.fcrn')
